          ...
          <div class="boxed-grey">
            ...
            <form align="center" id="register" class="form-horizontal" action="{{url('predict.store')}}">
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="form-group">
                    <label for="exampleSpam">
                                Masukan</label>
                    <textarea type="text" class="form-control" name="text_spam" id="Text_spam" placeholder="Lirik lagu" data-rule="minlen:10" data-msg="Please enter at least 8 chars of Text" /></textarea>
                ...
                <br>
                <div class="col-md-6">
                  <label for="examplePredict" name="result">Hasil</label>
                  <br>
                  <label for="examplePredict" name="result">Emosi</label>
                  ...
                  <label for="examplePredict" name="result">Genre</label>
                  <label for="examplePredict" id="predictGenre" class="form-control">
